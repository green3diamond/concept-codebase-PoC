...
export function FurnitureItem({ id, color, rotation, size, position, type, onDrag, onDragStart, onDragEnd, onModelClick, onEditClick, isEditVisible, setIsEditVisible }: CouchProps) {
  ...
  }, [gl, onDragEnd, onModelClick, setIsEditVisible, isDragging])
  ...
  }, [isPointerDown, isDragging, camera, raycaster, onDrag, onDragStart])
  ...
  return (
    ...
    >
      ...
      >
        <boxGeometry args={type === 'table' ? [1.2, 0.05, 0.8] : [length, 1.5, 1.5]} />
